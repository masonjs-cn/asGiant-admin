    ...
    <el-scrollbar style="height:600px">
      <el-form label-position="top">
        ...
        <el-form-item label="格栅" size="mini">
         ...
         <el-form-item label="编辑列宽">
          <el-checkbox v-model="data.disabled">编辑列宽</el-checkbox>
        </el-form-item>

        <el-form-item label="列宽度" size="mini">
          <el-input v-model.number="data.width"></el-input>
        </el-form-item>
        ...
        <el-form-item label="可见属性">
          ...
          <el-checkbox v-model="data.sortable">排序</el-checkbox>
        </el-form-item>
